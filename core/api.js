...
export async function invokeObsidianAction(action,payload={}){ const a=ObsidianActionAliases[action]; if(!a) throw new Error('Unknown OBSIDIAN action '+action); return liftEnvelope(await invoke(a.endpoint,{operation:a.operation,...payload})); }
