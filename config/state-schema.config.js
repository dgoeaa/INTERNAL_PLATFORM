export const RequiredStateCollections = Object.freeze(['activities','tracking','correspondence','operations','registryFiles','fileMovements','registryMinutes','escalations','notifications','dispatches','correspondenceEmails','comments','approvals','users','categories','departments','emails','audit','pending','briefs','meetings','projects']);
